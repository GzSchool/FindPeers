                  ...
                  wx.getSetting({
                    success: function(b) {
                      if (b.authSetting['scope.userInfo']) { //成功返回就是已经授权
                        ...
                        /*wx.redirectTo({
                          url: '/pages/index/index?othercardid=' + othercardid + '&openid=' + openid,
                        })*/
                      }
                    },
                    fail: function() {
              ...
              wx.getSetting({
                success: function(r) {
                  if (r.authSetting['scope.userInfo']) { //成功回调 说明已经授权过                                    
                        ...
                        wx.request({
                          ...
                          success: function(c) {
                            ...
                            if (c.data.data !== null || c.data.data !== "") { //要是有返回的 说明已经添加过信息
                              ...
                              wx.redirectTo({
                                url: '/pages/addcards/addcards?othercardid=' + othercardid + '&openid=' + openid,
                              })
                            }
                          },
                          fail: function() {
                    ...
                    var othercardid = that.globalData.othercardid; //说明还没有授权
                    var openid = that.globalData.openid;
                    that.globalData.notadd = true
                    wx.switchTab({
                      url: '/pages/findmore/findmore',
                    ...
                    if (c.authSetting['scope.userInfo']) { //说明授权了
                      ...
                      wx.request({
                        ...
                        success: function(d) {
                          ...
                          var openid = that.globalData.openid;
                          console.log(openid)
                          if (d.data.data !== null || c.data.data !== "") { //返回了 说明已经添加过信息了
